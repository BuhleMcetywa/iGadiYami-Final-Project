        ...
        public void SeedDatabase()
        {
            ...
            if (_dbConnection.Table<Disease>().Count() == 0)
            {
                ...
                disease = new Disease()
                {
                    ...
                    DiseaseCauses = "Early blight is caused by the fugus Alternaria linariae and occurs anytime during growing season, the pathogen is favoured by high humidity and temperatures above 24 degrees celsius.",
