        ...
        public void SeedDatabase()
        {
            ...
            if (_dbConnection.Table<Disease>().Count() == 0)
            {
                Disease disease = new Disease()
                {
                    ...
                    TagDescription = "Carrot Rust Fly Disease (Carrot)"
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription= "Alternaria Leaf Blight Disease (Carrot)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Root Knot Nematodes Disease (Carrot)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Bacterial Soft Rot Disease (Potato)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Blackleg Disease (Potato)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Late Blight on Disease (Potato)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription= "Early Blight Disease (Potato)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Powdery Scab Disease (Potato)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Anthracnose Disease (Spinach)"
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Downy Mildew Disease (Spinach)"
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "White Rust Disease (Spinach)"
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Fusarium Wilt Disease (Spinach)"
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Botrytis Blight Disease (Onion)"
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Botrytis Neck Rot Disease (Onion)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Downy Mildew Disease (Onions)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Purple Blotch Disease (Onions)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Anthracnose Disease (Tomato)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Blosom End Rot Disease (Tomato)"
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription = "Early Blight Disease (Tomato)"
                };
                _dbConnection.Insert(disease);
                ...
                disease = new Disease()
                {
                    ...
                    TagDescription= "Late Blight Disease (Tomato)"
                };
                _dbConnection.Insert(disease);
